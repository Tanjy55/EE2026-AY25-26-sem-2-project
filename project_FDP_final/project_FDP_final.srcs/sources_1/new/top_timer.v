...
module top_timer(
    ...
    else if(begin_flag == 1 && !death_flag && !success_flag) begin
        if (!time_up) begin
    ...
    always @(posedge clk) begin
        ...
        if (reset) begin
            // Immediately silence and reset audio states
            speaker_reg <= 0;
            audio_timer <= 0;
            blast_done <= 0;
            blast_duration <= 0;
        ...
        else if ((time_up && !blast_done) || death_flag) begin
